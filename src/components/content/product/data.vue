  ...
  <div class="data-content">
        ...
        <el-row  :gutter="40" class="row-bg" >
          <el-col  :sm="8" :xs="24" class="m-mb20">
            <el-card class="box-card" shadow="hover">
              <img src="../../../assets/image/data-icon1.png"/>
          ...
          <el-col  :sm="8" :xs="24" class="m-mb20">
            <el-card class="box-card" shadow="hover">
              <img src="../../../assets/image/data-icon2.png"/>
          ...
          <el-col  :sm="8" :xs="24" class="m-mb20">
            <el-card class="box-card" shadow="hover">
              <img src="../../../assets/image/data-icon3.png"/>
    ...
    <div class="access">
      ...
      <div style="padding-top: 32px">
        ...
        >
          <source src="../../../assets/video/DataxoOperate2.mp4" type="video/mp4">
          您的浏览器不支持 HTML5 video 标签。
        </video>
      </div>
      <div class="download">
        <a href="../../../assets/file/datax操作文档.pdf">
