    ...
    <div class="trait">
      ...
      <ul>
        ...
        <li class="pay">
          <el-row  class="row-bg">
          <el-col :sm="6" :xs="12">
            <img src="../../../assets/image/billing-icon.png">
            <span>In-app Billing</span>
          </el-col>
          <el-col :sm="6" :xs="12">
            <img src="../../../assets/image/ios-icon.png" style="height: 38px;width: 32px;margin-top: -3px">
            <span>In-app Purchase</span>
            </el-col>
          <el-col :sm="6" :xs="12" class="m-mtb20">
            <img src="../../../assets/image/weixin-icon.png" style="height: 32px;width: 36px;">
            <span>WeChat Pay</span>
          </el-col>
          <el-col :sm="6" :xs="12" class="m-mtb20">
            <img src="../../../assets/image/ali-icon.png" style="height: 34px;width: 34px;margin-top: -1px">
            <span>AliPay</span>
          </el-col>
         </el-row>
        </li>
