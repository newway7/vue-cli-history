  ...
  <div class="index-con">
    ...
    <div class="container solution">
      ...
      <h3 class="text-center">
        将我们的数据及开发能力，赋能到公司更多产品及业务线，提供整套数据解决方案
      </h3>
      <el-row
        type="flex"
        class="row-bg"
        ...
        <el-col :span="11" class="sports solution-box">
          ...
          >
            <dl @click="goSolutionPage('finance')">
              <dt>金融解决方案</dt>
              <dd>
                为金融业务量身定制的风控系统，具备安全稳定、敏捷高效、高弹性、高可用的特性
              </dd>
            </dl>
          </el-card>
        </el-col>
        ...
        >
          <el-card :body-style="{ padding: '0px' }" shadow="hover">
            <div class="text-center card">
              ...
              <p>{{ item.con }}</p>
              <a
                @click="goProductPage(item.href)"
                :class="[item.href == 'accountNum' ? 'bg-gray' : '']"
                >{{ item.btn }}</a
              >
            </div>
          </el-card>
  ...
  data() {
    return {
      ...
      banner: [
        {
          web: "CMBI",
          m_img: require("../../../assets/image/banner1.jpg")
        },
        {
          web: "CPBI",
          m_img: require("../../../assets/image/banner2.jpg")
        },
        {
          web: "DATAX",
          m_img: require("../../../assets/image/banner3.jpg")
        }
      ],
      product: [
        {
          img: require("../../../assets/image/index01.png"),
          tit: "支付系统",
        ...
        {
          img: require("../../../assets/image/index02.png"),
          tit: "数据系统",
        ...
        {
          img: require("../../../assets/image/index03.png"),
          tit: "大数据SDK",
        ...
        {
          img: require("../../../assets/image/index04.png"),
          tit: "帐号系统",
          con: "敬请期待……",
          btn: "查看详情",
          href: "accountNum"
...
.index-con {
  ...
  .product-box:hover {
    bottom: 6px;
    box-shadow: 0 6px 18px 0 rgba(232, 237, 250, 0);
  }
  .card a:hover {
    color: #fff;
    background: #409eff;
